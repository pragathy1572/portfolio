  ...
  return (
    ...
    >
      ...
      <section className="bg-gray-100 max-w-[65rem] border border-black/5 rounded-lg overflow-hidden sm:pr-8 relative sm:h-[20rem] hover:bg-gray-200 transition sm:group-even:pl-8 dark:text-white dark:bg-white/10 dark:hover:bg-white/20">
        ...
        <div className="pt-4 pb-7 px-10 sm:pl-10 sm:pr-2 sm:pt-10 sm:max-w-[50%] flex flex-col h-full sm:group-even:ml-[23rem]">
        ...
        <Image
          ...
          quality={95}
          className="absolute hidden sm:block top-8 -right-40 w-[32.25rem] rounded-t-lg shadow-2xl
        transition 
